...
class CategoryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin-panel.categories.create', compact('parentCategories', 'attributes'));
    }
    ...
    public function edit(Category $category)
    {
        ...
        return view('admin-panel.categories.edit', compact('category', 'parentCategories', 'attributes'));
    }
