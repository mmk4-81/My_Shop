...
@section('role','فروشنده ')

@section('mohtava')
<div id="mohtava-container" class="container p-4 rounded ">
    <h1>به داشبورد فروشگاه خوش آمدید</h1>
    ...
    <p>برای شروع، می‌توانید به بخش‌های مانند "مدیریت دسته بندی ها"، "مدیریت محصولات" و "سفارشات" مراجعه کنید.</p>
</div>
@endsection
