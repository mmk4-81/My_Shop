...
<div class="col-xl-12 col-md-12 mb-4 p-md-5">
    <div class="col-xl-12 col-md-12 mb-4 p-4">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                <label>وضعیت</label>
                <input class="form-control" type="text" value="{{ $product->is_active ? 'فعال' : 'غیرفعال' }}" disabled>
            </div>
            <div class="form-group col-md-3">
                <label>تاریخ ایجاد</label>
                <input class="form-control" type="text" value="{{ $product->created_at ? $product->created_at->format('Y-m-d H:i:s') : 'نامشخص' }}" disabled>
            </div>
        ...
        <a href="{{ route('seller.products.index') }}" class="btn btn-danger mt-5">بازگشت</a>
    </div>
</div>
@endsection
