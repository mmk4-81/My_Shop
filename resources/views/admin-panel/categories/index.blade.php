...
<div class="col-xl-12 col-md-12 mb-4 p-md-5">
    <div class="d-flex justify-content-between mb-4">
        ...
        <a class="btn btn-sm btn-danger" href="{{ route('admin.categories.create') }}">
                ...
                @foreach ($categories as $key => $category)
                    <tr>
                        ...
                        <th>
                            ...
                            <a class="btn btn-sm btn-info mr-3" href="{{ route('admin.categories.edit', ['category' => $category->id]) }}">ویرایش</a>
                            <form action="{{ route('admin.categories.destroy', ['category' => $category->id]) }}" method="POST" style="display:inline;" id="delete-form-{{ $category->id }}">
                                @csrf
                                @method('DELETE')
